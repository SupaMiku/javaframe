 ...
 */
public class addeditbooks extends javax.swing.JFrame {

    private boolean isEditMode = false;
private int edit_bok_id = -1;  // renamed from edit_a_id
...
public void setEditMode(int bok_id,String ttl, String auth, String gen, 
 ...
 isEditMode = true;
    ...
    bookid1.setText(String.valueOf(bok_id));
    bookid1.setEditable(false);
    bookid1.setBackground(new java.awt.Color(200, 200, 200));
    bookid1.setVisible(true);
    jLabel4.setVisible(true);
    ...
    // Fill fields
    title.setText(ttl != null ? ttl.trim() : "");
    author.setText(auth != null ? auth.trim() : "");
    genre.setText(gen != null ? gen.trim() : "");
    quantity.setText(qty != null ? qty.trim() : "");

    if (stat != null && !stat.trim().isEmpty()) {
        jComboBox1.setSelectedItem(stat.trim());
    } else {
        jComboBox1.setSelectedIndex(0);
    }

    setTitle("Edit Book – ID: " + bok_id);
    booklabel.setText("UPDATE");
}

private void clearAllFields() {
     bookid1.setText("");
    title.setText("");      // ✅ using title JTextField now
    author.setText("");
    genre.setText("");
    quantity.setText("");
    jComboBox1.setSelectedIndex(0);
    ...
    String titleVal    = title.getText().trim();     // ✅ title JTextField
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addeditbooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addeditbooks().setVisible(true);
            }
        });
    }
