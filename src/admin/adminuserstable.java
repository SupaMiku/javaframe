 ...
 */
public class adminuserstable extends javax.swing.JFrame {
...
private String safeGet(int row, int col) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminuserstable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminuserstable().setVisible(true);
            }
        });
    }
